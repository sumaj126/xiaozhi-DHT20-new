...
public:
    ...
    void SetReminder(int minutes, const std::string& message);
    ...
    // Reminder TTS helper methods
    void HandleReminderFailure();
    void HandleReminderCompletion();
...
private:
    ...
    ReminderTimer reminder_timer_;

    bool has_server_time_ = false;
    bool aborted_ = false;
    bool assets_version_checked_ = false;
    bool play_popup_on_listening_ = false;  // Flag to play popup sound after state changes to listening
    bool reminder_tts_active_ = false;     // Flag to track if reminder TTS is playing
    esp_timer_handle_t reminder_tts_timer_ = nullptr;  // Timer for TTS timeout handling
    int clock_ticks_ = 0;
